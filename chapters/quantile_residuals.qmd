...
#| label: fig-06
#| column: margin
#| fig-cap: "Conventinal residual plots for Poisson GLMM"

plot(fitted(rightModel), residuals(rightModel, type = "deviance"), main = NULL, xlab = "fitted values", ylab = "deviance residuals", col = "#368BC1", cex.axis = 1.8, cex.lab = 1.8, cex = 1.5); abline(h = 0)
```
...
```{r}
#| label: fig-09
#| fig-cap: "Conditional simulation of a glmmTMB object"
...
```{r}
#| label: fig-10
#| fig-cap: "Unconditional simulation of a glmmTMB object"
